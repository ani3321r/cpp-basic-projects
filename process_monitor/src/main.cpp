...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    // Create system monitor components
    try {
        auto metricsCollector = std::make_unique<MetricsCollector>();
        auto dataLogger = std::make_unique<DataLogger>();
        auto systemMonitor = std::make_unique<SystemMonitor>(metricsCollector.get(), dataLogger.get());
        auto mainWindow = std::make_unique<MainWindow>(systemMonitor.get());
